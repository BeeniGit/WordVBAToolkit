...
' release
Public Const TOOLKIT_VERSION As String = "v1.2.1" 'Version format v{majorUpdate}.{minorUpdate}.{Patch}
Public Const TOOLKIT_RELEASE_DATE As String = "07/08/2026" 'Date format DD/MM/YYYY
