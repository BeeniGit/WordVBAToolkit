VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} CSVToTableForm 
   Caption         =   "Convert CSV list of words to table"
   ClientHeight    =   7920
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   10965
   OleObjectBlob   =   "CSVToTableForm.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "CSVToTableForm"
...
Private Sub UserForm_Initialize()
    ...
    ' Initializing the Color Dropdown Menu
    With cmbBorderColor
        .AddItem "Black"
        .AddItem "Red"
        .AddItem "Blue"
    ...
    ' Table Border Initialization Thicknesses
    With cmbBorderSize
...
'
' Description :
'   Update the value of the top linked to the columns according to the value entered by the user in the text area
'
' Parameters :
'   N/A
'
